...
const Visualizer = ({ audioData, isListening, intensity = 0, width = 600, height = 400 }) => {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            const radius = baseRadius + (currentIntensity * 40) + 25;
            ...
            ctx.strokeStyle = 'rgba(255, 10, 10, 0.1)';
            ctx.lineWidth = 2;
            ctx.stroke();
        ...
        <div className="relative" style={{ width, height }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                <motion.div
                    ...
                    className="text-red-100 font-bold tracking-widest drop-shadow-[0_0_15px_rgba(34,211,238,0.8)]"
